...
I forked this repo and the dependency uWebSockets and it's dependency uSockets so that I could
change a parameter in the uSockets library. This project is setup to build binaries via github
actions and push them to the binaries branch. The releases are then tags that point to that branch.
